...
let ODLine = {
  ...
  addPathPoints(linePoints) {
    ...
    for (let k = 0; k < linePoints.length; k++) {
      ...
      this.webgl.toRenderCoordinates(this.view, [linePoints[k][0][0], linePoints[k][0][1], 10], 0, this.view.spatialReference, startPoint, 0, 1)
      this.webgl.toRenderCoordinates(this.view, [linePoints[k][1][0], linePoints[k][1][1], 10], 0, this.view.spatialReference, endPoint, 0, 1)
    ...
    for (let i = 0; i < linePoints.length; i++) {
      ...
      this.webgl.toRenderCoordinates(this.view, [point1[0], point1[1], 10], 0, this.view.spatialReference, xyz1, 0, 1)
      this.webgl.toRenderCoordinates(this.view, [point2[0], point2[1], 10], 0, this.view.spatialReference, xyz2, 0, 1)
